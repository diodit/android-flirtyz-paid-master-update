 ...
 * Use the {@link ActionFirstFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ActionFirstFragment extends Fragment {
     ...
     * @return A new instance of fragment ActionFirstFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ActionFirstFragment newInstance(String param1, String param2) {
        ActionFirstFragment fragment = new ActionFirstFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_action_first, container, false);

        purchasesContainer = new ArrayList<>();
        List<Purchase> purchase = purchasesGenerator(purchasesContainer);
        recyclerView = view.findViewById(R.id.first);
